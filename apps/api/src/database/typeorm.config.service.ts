...
export class TypeOrmConfigService implements TypeOrmOptionsFactory {
    ...
    createTypeOrmOptions(): TypeOrmModuleOptions {
        ...
        const baseName =
            this.cfg.get<string>('DATABASE_NAME') ?? 'tali_talent_org_health_development';
        const database = isTest
            ? baseName.replace(/_development$/, '') + '_test'
            : baseName;
        ...
        const opts: TypeOrmModuleOptions = {
            ...
            username:
                this.cfg.get<string>('DATABASE_USERNAME') ??
                this.cfg.get<string>('DB_USER', 'root'),
            password:
                this.cfg.get<string>('DATABASE_PASSWORD') ??
                this.cfg.get<string>('DB_PASSWORD', 'password'),
            database,
        ...
        if (!isProd) {
            ...
            console.log('[TypeORM Config]', { ...opts, password: opts.password ? '***' : undefined });
        }
